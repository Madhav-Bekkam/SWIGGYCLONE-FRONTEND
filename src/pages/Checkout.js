...
export default function Checkout() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const result = await axios.post("http://localhost:5000/api/payment/create", { amount: final });
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          const verifyRes = await axios.post("http://localhost:5000/api/payment/verify", verifyData);
